...
describe('SignUp Controller', () => {
  ...
  test('Should return 400 if no name is password', async () => {
    const { sut } = makeSut()
  ...
  test('Should return 400 if no password confirmation is different from password', async () => {
    const { sut } = makeSut()
  ...
  test('Should return 500 if email validator throws a error', async () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  test('Should return 500 if addAccount throws a error', async () => {
    const { sut, addAccountStub } = makeSut()
